---
title: 'Polkadot 2.0 Tutorial: Upgrading a Parachain to Async Backing'
date: '2025-09-10'
authors: ['1-dustin']
...
Asynchronous Backing is a major Polkadot network upgrade that decouples parachain block production from the Relay Chain's block production. This allows parachains to build blocks in a continuous pipeline, targeting a **6-second block time** instead of 12 seconds, which significantly increases network throughput and efficiency.
