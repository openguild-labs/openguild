...
Bạn có thể xem thêm mã nguồn của Price Oracle Pallet được triển khai sử dụng Offchain workers tại đây: [Code Breakdown @ Pallet Price Oracles](https://lowlevelers.com/blog/polkadot/code-breakdown-pallet-price-oracle)
...
Bên trong Pallet của bạn, nếu bạn chưa biết về Pallet xem qua bài này [Polkadot Guide: Pallet là gì?](https://lowlevelers.com/blog/polkadot/polkadot-guide-pallet-la-gi) hoặc [Code Breakdown: Template for FRAME pallet](https://lowlevelers.com/blog/polkadot/code-breakdown-pallet-template) để hiểu thêm về Pallet trước khi tìm hiểu đến Offchain Workers.
...
4. [Offchain storage](https://lowlevelers.com/blog/polkadot/polkadot-guide-offchain-storage) được chia sẻ giữa các offchain workers
