...
- [Polkadot Guide: Pallet là gì?](https://lowlevelers.com/blog/polkadot/polkadot-guide-pallet-la-gi)
...
> Hàm thức phải được khai báo weight với `pallet::weight` và phải trả về DispatchResult. Tìm hiểu thêm về weight tại đây [Khái niệm về Transaction Fee và Weight](https://lowlevelers.com/blog/polkadot/polkadot-guide-transaction-fee-weights)
