...
---
title: 'Tutorial: Deploying Uniswap V2 on PolkaVM'
date: '2025-18-09'
authors: ['1-dustin']
tags: ['technical', 'blockchain', 'polkadot', 'solidity', 'polkaVM', 'lang-en']
draft: false
summary: 'This guide provides a complete walkthrough for deploying a Uniswap V2 instance to the PolkaVM, the EVM-compatible layer on Asset Hub. By following these steps, you can migrate your existing Web3 dApps to the Polkadot ecosystem.'
---
...
| Network | Type | Faucet Link |
| :--- | :--- | :--- |
| **Kusama Asset Hub** | Mainnet | N/A (Requires real KSM) |
| **Paseo Asset Hub** | Testnet | https://faucet.polkadot.io/?parachain=1111 |



Before you begin, you need to have KUS tokens on the Kusama Asset Hub.
...
### 4.2. Deploy the ERC20 Token Contract

```bash
npx hardhat ignition deploy ignition/modules/UniswapV2ERC20.js --network kusamaHub
```
...
### 4.3. Deploy the WETH Contract

```bash
npx hardhat ignition deploy ignition/modules/UniswapV2WETH.js --network kusamaHub
```
...
### 4.4. Deploy the Factory Contract

```bash
npx hardhat ignition deploy ignition/modules/UniswapV2Factory.js --network kusamaHub
```
...
### 4.5. Deploy a Liquidity Pair

```bash
npx hardhat ignition deploy ignition/modules/UniswapV2Pair.js --network kusamaHub
```
...
You have successfully deployed a full Uniswap V2 instance to Kusama Asset Hub\! This process demonstrates how to deploy any Solidity smart contract to PolkaVM.
