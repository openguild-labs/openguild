...
![Access Kusama Asset AssetHub](../../../public/static/images/polkadot/blog/polkadot-deploy-uniswapv2/asset_hub.png)

2.  Navigate to **Developer \> Extrinsics**.
3.  Submit the extrinsic: `revive.mapAccount()`.

![Map Account](../../../public/static/images/polkadot/blog/polkadot-deploy-uniswapv2/map_account.png)
...
![Call](../../../public/static/images/polkadot/blog/polkadot-deploy-uniswapv2/call.png)
...
> **💡 Important: The project already configured `Passet Asset Hub` and `Kusama Asset Hub` on `hardhat.config.js` **
...
Your next steps could be:
  ...
  * **Provide Liquidity:** Create new pairs and add funds to your liquidity pools.
    ...
    ![Add Liquidity](../../../public/static/images/polkadot/blog/polkadot-deploy-uniswapv2/add_liquidity.png)

  * **Swap Tokens:** Execute trades using the UI.

    ![Swap Tokens](../../../public/static/images/polkadot/blog/polkadot-deploy-uniswapv2/swap.png)

  * **Explore:** Query and display information about all available liquidity pools.

    ![Explore](../../../public/static/images/polkadot/blog/polkadot-deploy-uniswapv2/pools.png)