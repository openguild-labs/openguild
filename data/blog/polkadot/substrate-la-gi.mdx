...
draft: false
summary: Substrate là một _bộ công cụ phát triển phần mềm (SDK - Software Development Kit)_ được cung cấp bởi Parity Technologies nhằm hỗ trợ phát triển các nút blockchain với khả năng cấu hình và mở rộng dễ dàng không phụ thuộc vào trạng thái của giao thức mạng blockchain...
---
