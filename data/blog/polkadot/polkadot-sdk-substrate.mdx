---
title: 'Polkadot Guide: Substrate là gì?'
date: '2023-11-10'
authors: ['1-tin-chung']
tags: ['technical', 'blockchain', 'polkadot', 'beginner', 'substrate', 'lang-vn']
draft: false
summary: Substrate là một bộ công cụ phát triển phần mềm (SDK - Software Development Kit) được cung cấp bởi Parity Technologies nhằm hỗ trợ phát triển các nút blockchain với khả năng cấu hình và mở rộng dễ dàng không phụ thuộc vào trạng thái của giao thức mạng blockchain...
---

_Language_: Vietnamese
_Cấp độ_: Begineer

# Polkadot Guide: Substrate là gì?

## Bài viết liên quan

- [Polkadot SDK là gì?](https://lowlevelers.com/blog/polkadot/vn/polkadot-sdk-la-gi)
