...
This guide shows you how to deploy a Solidity smart contract to a Polkadot testnet using Foundry.
...
➡️ **Faucet**: [https://faucet.polkadot.io/?parachain=1111](https://faucet.polkadot.io/?parachain=1111)
...
**✅ The Solution:** Just like with building, you must add the **`--resolc`** flag to your deployment command. This ensures Foundry sends the correct PolkaVM-compatible bytecode.
