...
draft: false
summary: 'The EVM Transaction Lifecycle on Polkadot Asset Hub represents a paradigm shift in how Polkadot achieves Ethereum compatibility'
---
...
| **Execution Layer** | The underlying execution engine:<br /><br />• **PolkaVM** is a register-based VM (RISC-V), allowing for JIT compilation and near-native speeds.<br /><br />• **EVM** is a stack-based VM , EVM-compatible like Ethereum, Base,… |
| **Compiler** | Two types of compilers:<br /><br />• **Resolc**: A modified Solidity compiler that takes Solidity source code and outputs PolkaVM-compatible RISC-V bytecode<br /><br />• **Solc**: EVM bytecode. |
