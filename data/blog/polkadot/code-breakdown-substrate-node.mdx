...
Các máy tính tham gia trở thành một phần của mạng lưới blockchain được gọi là các **node**. Và trong Polkadot, các node này sẽ được xây dựng bằng [Polkadot SDK - Substrate](https://openguild.wtf/blog/polkadot/vn/polkadot-sdk-substrate).của bộ công cụ phát triển [Polkadot SDK](https://openguild.wtf/blog/polkadot/vn/polkadot-sdk-la-gi)
