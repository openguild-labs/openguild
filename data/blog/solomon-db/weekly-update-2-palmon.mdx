---
title: 'SolomonDB Weekly Update (#2): Palmon'
date: '2022-11-21'
tags: ['technical', 'database', 'embedded', 'low-level-log']
draft: false
summary: Storage engine is added to SolomonDB following Adapter design pattern
---
...
![fig](https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/Paimon.jpg/180px-Paimon.jpg)
